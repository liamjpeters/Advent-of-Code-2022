...
# a monkey's inspection didn't damage an item no longer causes your worry level to be divided by 
# three.
...
Write-Host "The level of monkey business after 10000 rounds is '$($Top2Inspected[0] * $Top2Inspected[1])'"
